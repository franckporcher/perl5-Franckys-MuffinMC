...
m_explain('test 27',   '=(formule "( #(. #(map $(cv) #(.. 1 #(consonnes))))))',       ['"c$(voyelles)g$(voyelles)m$(voyelles)"']);
...
m_explain('test 29a',  q{  #(eval "( #(map   '(#(. @(consonnes $(_1)) \$(voyelles)))   #(.. 1 #(consonnes)))) ) }, $acronymes);
m_explain('test 29b',  q{  M( "( #(map   '(#(. @(consonnes $(_1)) \$(voyelles)))   #(.. 1 #(consonnes)))) ) }, $acronymes);
